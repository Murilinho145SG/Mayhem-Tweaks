...
public class BlockRegistry {
    ...
    private static final Item.Settings ITEMS_PROPERTIES = new Item.Settings().group(Groups.MAINTAB);
    ...
    public static final Block EVA_DOOR = new DoorBlock(EVA_SETTINGS.nonOpaque());
    public static final Block SEWING_TABLE = new SewingTableBlock(FabricBlockSettings.of(Material.WOOD).strength(2.0f).sounds(BlockSoundGroup.WOOD).nonOpaque());
    public static void registryBlock() {
        ...
        BlockUtils.registryBlock("eva_door", EVA_DOOR, EVA_PROPERTIES);
        BlockUtils.registryBlock("sewing_table", SEWING_TABLE, ITEMS_PROPERTIES);
    }
}
